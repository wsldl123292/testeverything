...
public interface ISparkJobServerClient {
     ...
     * <p>This method implements the Rest API <code>'GET /jars' </code>of the
     * Spark Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'POST /jars/&lt;appName&gt;' </code>
     ...
     * <p>This method implements the Rest API <code>'GET /contexts '</code>
     * of the Spark Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'POST /contexts/&lt;name&gt;' </code>
     * of the Spark Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'DELETE /contexts/&lt;name&gt;' </code>
     * of the Spark Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'GET /jobs' </code> of the Spark
     * Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'POST /jobs' </code> of the Spark
     * Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'GET /jobs/&lt;jobId&gt;' </code>
     * of the Spark Job Server.
     *
     ...
     * <p>This method implements the Rest API <code>'GET /jobs/&lt;jobId&gt;/config' </code>
     * of the Spark Job Server.
     *
     * @param jobId the id of the target job
